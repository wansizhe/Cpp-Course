...
/* ----main函数不准动，也不需要提交，检查时会替换---- */
int main()
{
	if (1) {
		Date d1;             //2000.1.1
		Date d2(2016, 4, 28);  //2016.4.28

		cout << "测试初始化，完全正确的赋值" << endl;

		cout << "d1应该是2000.1.1， 实际为：";
		d1.show();
		cout << "d2应该是2016.4.28，实际为：";
		d2.show();
	...
	if (1) {
		Date d1(2015, 2, 29);   //2015.2.1
		Date d2(2016, 2, 29);   //2016.2.29

		cout << "测试初始化，闰年" << endl;

		cout << "d1应该是2015.2.1， 实际为：";
		d1.show();
	...
	if (1) {
		...
		d1.set(2016, 4, 28);	//2016.4.28
		d2.set(2016, 4);		//2016.4.1
		d3.set(2016);		//2016.1.1

		cout << "d1应该是2016.4.28，实际为：";
		d1.show();
		cout << "d2应该是2016.4.1， 实际为：";
		d2.show();
		cout << "d3应该是2016.1.1， 实际为：";
		d3.show();
	...
	if (1) {
		...
		d1.set(2007, 0, 0);   //2007.4.28
		d2.set(0, 3, 18);   //2016.3.18
		d3.set(0, 0, 18);   //2016.4.18

		cout << "d1应该是2007.4.28，实际为：";
		d1.show();
		cout << "d2应该是2016.3.18，实际为：";
		d2.show();
		cout << "d3应该是2016.4.18，实际为：";
		d3.show();
	...
	if (1) {
		...
		cout << "测试cout" << endl;
		cout << "d1应该是2016.4.28，实际为：" << d1 << endl;
	...
	if (1) {
		...
		cout << "请输入2015 2 29" << endl;
		cin >> d1;
		cout << "d1应该是2015.2.1，实际为：" << d1 << endl;

		cout << "请输入1899 4 10" << endl;
		cin >> d1;
		cout << "d1应该是2000.4.10，实际为：" << d1 << endl;

		cout << "请输入2016 13 10" << endl;
		cin >> d1;
		cout << "d1应该是2016.1.10，实际为：" << d1 << endl;

		cout << "请输入2016 4 31" << endl;
		cin >> d1;
		cout << "d1应该是2016.4.1，实际为：" << d1 << endl;
	...
	if (1) {
		...
		cout << "d4应该是42487， 实际为：" << int(d4) << endl;
	...
	if (1) {
		...
		d2 = d1 + 38;
		cout << "d2应该是2016.6.5， 实际为：" << d2 << endl;

		d2 = 38 + d1;
		cout << "d2应该是2016.6.5， 实际为：" << d2 << endl;

		d2 = d1 - 7;
		cout << "d2应该是2015.4.21， 实际为：" << d2 << endl;
		...
		d1.set(2015, 2, 28);
		d2 = d1 + 3;
		cout << "d2应该是2015.3.3，  实际为：" << d2 << endl;
	...
	if (1) {
		...
		d1.set(2016, 5, 1);
		d2 = d1++;
		cout << "d1应该是2016.5.2，  实际为：" << d1 << endl;
		cout << "d2应该是2016.5.1，  实际为：" << d2 << endl;

		d1.set(2016, 5, 1);
		d2 = ++d1;
		cout << "d1应该是2016.5.2，  实际为：" << d1 << endl;
		cout << "d2应该是2016.5.2，  实际为：" << d2 << endl;

		d1.set(2016, 5, 1);
		d2 = d1--;
		cout << "d1应该是2016.4.30， 实际为：" << d1 << endl;
		cout << "d2应该是2016.5.1，  实际为：" << d2 << endl;

		d1.set(2016, 5, 1);
		d2 = --d1;
		cout << "d1应该是2016.4.30， 实际为：" << d1 << endl;
		cout << "d2应该是2016.4.30， 实际为：" << d2 << endl;

		d1.set(2012, 12, 31);
		d2 = d1++;
		cout << "d1应该是2013.1.1，  实际为：" << d1 << endl;
		cout << "d2应该是2012.12.31，实际为：" << d2 << endl;

		d1.set(2016, 1, 1);
		d2 = d1--;
		cout << "d1应该是2015.12.31，实际为：" << d1 << endl;
		cout << "d2应该是2016.1.1，  实际为：" << d2 << endl;
		...
		d1.set(2015, 2, 28);
		d2 = d1++;
		cout << "d1应该是2015.3.1，  实际为：" << d1 << endl;
		cout << "d2应该是2015.2.28， 实际为：" << d2 << endl;
		...
		d1.set(2015, 3, 1);
		d2 = d1--;
		cout << "d1应该是2015.2.28， 实际为：" << d1 << endl;
		cout << "d2应该是2015.3.1，  实际为：" << d2 << endl;
